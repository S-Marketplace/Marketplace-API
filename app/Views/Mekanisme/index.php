        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text">Data mekanisme.</p>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#btnEdit', function(e) {
            ...
            $('#kode').val(dataRow.kode);
            $('#nama').val(dataRow.nama);

            if (dataRow.foto != '') {
                krajeeConfig('[name="foto"]', {
                    url: `<?= base_url('File/get/foto_mekanisme') ?>/${dataRow.foto}`,
                    filename: dataRow.foto,
                    caption: `Foto Mekanisme ${dataRow.nama}`,
                    action: true,
                    type: 'image',
                });
            } else {
        ...
        grid = $("#datatable").DataTable({
            ...
            columns: [{
                ...
                },
                {
                    data: 'foto',
                    render: function(val, type, row, meta) {
                        let link = `<?= base_url('File') ?>/get/foto_mekanisme/${val}`;
