        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text">Data jadwal kunjungan umum.</p>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // Select2 untuk Inputan Hari
        select2config("hari", "Hari");
