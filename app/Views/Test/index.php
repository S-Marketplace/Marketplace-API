                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <fieldset>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" checked name="customCheck4" id="customCheck4" disabled>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <p>Add <code>.c-input.c-radio</code> as a single wrapper &amp; add
                                        <code>&lt;span class="c-indicator"&gt;&lt;/span&gt;</code> for better output &amp; wrap with <code>right-radio</code> for right aligned radio.
                                    </p>
                                    <fieldset class="right-radio">
                                        <div class="custom-control custom-radio">
                                    ...
                                    <fieldset class="right-radio disabled">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" name="customRadioRight" id="customRadioRight3" disabled>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <fieldset>
                                        ...
                                        <div class="d-inline-block custom-control custom-checkbox mr-1">
                                            <input type="checkbox" class="custom-control-input bg-success" name="colorCheck" id="colorCheck2" checked>
