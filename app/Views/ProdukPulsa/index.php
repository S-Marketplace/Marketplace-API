...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('change', '#kategoriSort', function(e) {
            e.preventDefault();
        ...
        function buildContent(item) {
            ...
            return `<div class="p-1">
                    <div class="media-body">
                        ...
                        <div>
                            <small class="font-weight-bold"><span class="text-primary">${item.urutan}</span> ${item.nama}</small> 
                        </div>
