...
<div class="page-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text">Data foto beranda.</p>
    ...
    <?= $this->include('FotoBeranda/modal'); ?>
</div>
<?= $this->endSection(); ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#btnEdit', function(e) {
            ...
            $('[name="isActive"]').val(dataRow.isActive);
            $('#isActive').bootstrapToggle((dataRow.isActive == 1) ? 'on' : 'off');

            if (dataRow.foto != '') {
                krajeeConfig('[name="foto"]', {
                    url: `<?= base_url('File/get/foto_beranda') ?>/${dataRow.foto}`,
                    filename: dataRow.foto,
                    caption: `Foto Beranda`,
                    action: true,
                    type: 'image',
                });
            } else {
        ...
        grid = $("#datatable").DataTable({
            ...
            columns: [{
                ...
                },
                {
                    data: 'foto',
                    render: function(val, type, row, meta) {
                        let link = `<?= base_url('File') ?>/get/foto_beranda/${val}`;
         ...
         * labelFotoBeranda
         *
         * menampilkan status Foto Beranda
         *
         * @param {int} status
         * @param {boolean} pull
         */
        function labelFotoBeranda(status, popover = "", pull = false) {
            if (status == 1) {
                labelClass = "primary";
                text = 'Aktif';
            } else {
            ...
            classPull = pull ? "pull-right" : "";

            statusView = `<span class="${classPull}">${labelStart}${text}${popover}${labelEnd}</span>`;
