...
<div class="page-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text">Data layanan pengaduan.</p>
    ...
    <?= $this->include('LayananPengaduan/modal'); ?>
</div>
<?= $this->endSection(); ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on("change", "#color", function() {
            $('.icon-preview-item .fa, .icon-container').css({
                'color': $(this).val()
            });
        });
        ...
        $('.icon-container').click(function(event) {
            ...
            $('#preview').show();
            $('.icon-preview-item .fa').attr('class', 'fa ' + icon + ' fa-2x');
        });
        ...
        $('#btnTambah').click(function(e) {
            ...
            $('#preview').hide();
            $('input').val('');
            $('input[type="color"]').val('').trigger('change');
        });
        ...
        $(document).on('click', '#btnEdit', function(e) {
            ...
            $('#link').val(dataRow.link);
            $('#icon').val(dataRow.icon);
            $('input[type="color"]').val(dataRow.color);

            $('#preview').show();
            $('.icon-preview-item .fa').attr('class', 'fa ' + dataRow.icon + ' fa-2x').css({
                'color': dataRow.color
            });
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(val, type, row, meta) {
                        ...
                        return `<i class="fa ${val} fa-2x" style="${style}"></i>`;
                    }
                },
                {
                    data: 'nama',
