...
<div class="page-body">
    ...
    <?= $this->include('MenuDigital/modal'); ?>
</div>
<?= $this->endSection(); ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#btnEdit', function(e) {
            ...
            $('[name="jenisMenu"]').val(dataRow.jenisMenu).trigger('change');
            $('[name="showHome"]').val(dataRow.showHome).trigger('change');
            $('[name="enabled"]').val(dataRow.enabled).trigger('change');
        ...
        grid = $("#datatable").DataTable({
            ...
            columns: [{
                ...
                },
                {
                    data: 'enabled',
                    render: function(val, type, row, meta) {
                        let enabled = val == 1 ? '<span class="badge badge-success">Enabled</span>' : '<span class="badge badge-danger">Disabled</span>';
                        let showHome = row.showHome == 1 ? '<span class="badge badge-success">Show Home</span>' : '<span class="badge badge-danger">Show Home</span>';
