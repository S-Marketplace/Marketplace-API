  ...
  <body class="landing-page">
    ...
    <div class="page-wrapper landing-page">
      ...
      <div class="landing-home">
        <ul class="decoration">
          <li class="one"><img class="img-fluid" src="<?=base_url()?>/assets/images/landing/decore/1.png" alt=""></li>
          <li class="two"><img class="img-fluid" src="<?=base_url()?>/assets/images/landing/decore/2.png" alt=""></li>
          <li class="three"><img class="img-fluid" src="<?=base_url()?>/assets/images/landing/decore/4.png" alt=""></li>
          <li class="four"><img class="img-fluid" src="<?=base_url()?>/assets/images/landing/decore/3.png" alt=""></li>
          <li class="five"><img class="img-fluid" src="<?=base_url()?>/assets/images/landing/2.png" alt=""></li>
          <li class="six"><img class="img-fluid" src="<?=base_url()?>/assets/images/landing/decore/cloud.png" alt=""></li>
          <li class="seven"><img class="img-fluid" src="<?=base_url()?>/assets/images/landing/2.png" alt=""></li>
        </ul>
              ...
              <nav class="navbar navbar-b navbar-trans navbar-expand-xl fixed-top nav-padding" id="sidebar-menu"><a class="navbar-brand p-0" href="#"><img class="img-fluid" src="<?=base_url()?>/assets/images/landing/landing_logo.png" alt=""></a>
                ...
                <div class="navbar-collapse justify-content-end collapse hidenav" id="navbarDefault">
                  <ul class="navbar-nav navbar_nav_modify" id="scroll-spy">
                    ...
                    <li class="nav-item buy-btn"><a class="nav-link js-scroll" href="<?= base_url('Login')?>" target="_blank">Login</a></li>
                  </ul>
                </div>
              </nav>
            </header>
    ...
    <script src="<?=base_url()?>/assets/js/landing_sticky.js"></script>
