            ...
            <div class="col-xl-5 col-lg-6">
              <div class="content">
                <div>
                  ...
                  <div class="btn-grp mt-4"><a class="btn btn-pill btn-primary btn-air-primary btn-lg me-3 wow pulse" href="index.html" target="_blank"> <img src="../assets/images/landing/icon/html/html.png" alt="">HTML</a><a class="btn btn-pill btn-secondary btn-air-secondary btn-lg me-3 wow pulse" href="https://react.pixelstrap.com/cuba/dashboard/default" target="_blank"><img src="../assets/images/landing/icon/react/react.png" alt="">React</a><a class="btn btn-pill btn-info btn-air-info btn-lg wow pulse" href="http://angular.pixelstrap.com/cuba/" target="_blank"> <img src="../assets/images/landing/icon/angular/angular.svg" alt="">Angular</a></div>
        ...
        <div class="container-fluid container-modify apps">
          <div class="landing-slider">
            <div class="row">
              ...
              <div class="col-xl-3 col-lg-4 col-sm-6 mb-4">
                <div class="img-effect mb-3"><a href="../theme/to-do.html" target="_blank"><img class="img-fluid cuba-img" src="../assets/images/landing/todo_app.jpg" alt=""></a></div>
                <h4>To-Do</h4>
              </div>
              <div class="col-xl-3 col-lg-4 col-sm-6 mb-4">
