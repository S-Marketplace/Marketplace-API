      ...
      <div class="error-wrapper maintenance-bg">
        <div class="container">
          ...
          <div class="maintenance-heading">
            <h2 class="headline">SUKSES</h2>
          </div>
          <h4 class="sub-content">Akun anda berhasil di aktivasi<br>Silahkan login menggunakan email yang telah anda daftarkan</h4>
          <div><a class="btn btn-primary-gradien btn-lg text-light" href="<?=base_url()?>">Kembali ke halaman utama</a></div>
        </div>
      </div>
      <!-- Maintenance end-->
    </div>
