...
class UserSaldoModel extends MyModel
{
    ...
    protected $allowedFields = ["usalId", "usalPaymentType", "usalPaymentCode", "usalStore", "usalStatus","usalTime","usalSignatureKey","usalOrderId","usalMerchantId","usalGrossAmount","usalCurrency","usalVaNumber", "usalRekNumber", "usalBank","usalBillerCode","usalBillKey","usalUserEmail",'usalStatusSaldo','usalExpiredDate',];
