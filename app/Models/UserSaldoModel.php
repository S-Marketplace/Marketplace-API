...
class UserSaldoModel extends MyModel
{
    ...
    protected $allowedFields = ["usalId", "usalPaymentType","usalStatus","usalTime","usalSignatureKey","usalOrderId","usalMerchantId","usalGrossAmount","usalCurrency","usalVaNumber","usalBank","usalBillerCode","usalBillKey","usalUserEmail",'usalStatusSaldo','usalExpiredDate',];
