...
class AntrianKunjungan extends BaseController
{
    protected $activeUrl = 'AntrianKunjungan';
    protected $model = '';
    ...
    //     'namaWbp' => ['label' => 'Nama WBP', 'rules' => 'required'],
    //     'namaAyah' => ['label' => 'Nama Ayah Kandung', 'rules' => 'required'],
    // ];
    ...
    public function grid()
    {
        ...
        $this->model->where('antJenis', 'Kunjungan');
